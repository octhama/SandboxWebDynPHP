...
<head>
    <meta charset="UTF-8">
    <title>ToDoList - Corbeille</title>
                ...
                <tr>
                    <td>
                        <?php if ($todo['completed'] || $todo['progress'] == 100): ?>
                            <span class="text-decoration-line-through"><?php echo htmlspecialchars($todo['task']); ?></span>
                        <?php else: ?>
                            <?php echo htmlspecialchars($todo['task']); ?>
                        <?php endif; ?>
                    </td>
                    <td><?php echo htmlspecialchars($todo['date']); ?></td>
                    <td><?php if (!empty($todo['time'])) {
                    ...
                    <td><?php echo $todo['completed'] || $todo['progress'] == 100 ? 'Terminé' : 'Non terminé'; ?></td>
                    <td>
